...
namespace BarangayCMS.Web.Areas.Admin.Models
{
    public class BudgetViewModel
    {
        ...
        // 🔑 PINAGMULAN NG PONDO (MOTHER FUND)
        [Required(ErrorMessage = "Pumili ng Pinagmulan ng Pondo (Fund Source).")]
        [Display(Name = "Pinagmulan ng Pondo (Main Fund Source)")]
        ...
        [Display(Name = "Kategorya / Program (Category)")]
